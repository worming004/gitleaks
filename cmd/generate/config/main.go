...
func main() {
	...
	configRules = append(configRules, rules.DotnetAppSettingsClientSecret())
	configRules = append(configRules, rules.DotnetAppSettingsEsbPassword())
	configRules = append(configRules, rules.DotnetAppSettingsPasswordValue())
